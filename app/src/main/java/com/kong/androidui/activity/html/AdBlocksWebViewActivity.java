package com.kong.androidui.activity.html;
...
import com.kong.androidui.util.AdBlocker;
import com.kong.androidui.util.ClipboardUtils;
import com.kong.androidui.util.FileUtils;
import com.kong.androidui.util.PermissionUtils;
import com.kong.androidui.util.presenter.WebViewPresenterImpl;
...
public class AdBlocksWebViewActivity extends AppCompatActivity implements WebViewPresenterImpl.View,
    ...
    private void bindView() {
        ...
        mBtnMore = (ImageButton) findViewById(R.id.toolbar_btn_more);
    ...
    private void initPopupMenu() {
        ...
        mBtnBack = (ImageButton) view.findViewById(R.id.popup_menu_btn_back);
        mBtnFoward = (ImageButton) view.findViewById(R.id.popup_menu_btn_forward);
